...
export const en: Record<MessageKey, string> = {
  ...
  ask_qty: "How many « {name} »? (or type 4–20)",
  btn_qty_1: "1",
  btn_qty_2: "2",
  btn_qty_3: "3",
  ...
  cart_after_add:
    "Added: {name} ×{qty}\n\n{lines}\n\nTotal: {total} XAF\n\nType 2–20 to change this dish’s quantity.",
  cart_line: "• {name} ×{qty} — {subtotal} XAF",
  btn_add_item: "Add more",
  btn_view_cart: "Cart",
  btn_edit_cart: "Edit cart",
  btn_checkout: "Checkout",
  btn_clear_cart: "Clear",
  cart_cleared: "Cart cleared.",
  cart_prompt: "Add more, checkout, or clear the cart?",
  cart_qty_updated: "Quantity updated: {name} ×{qty}",
  ...
  order_cancelled: "Order cancelled. Here’s your cart — edit or start again.",
